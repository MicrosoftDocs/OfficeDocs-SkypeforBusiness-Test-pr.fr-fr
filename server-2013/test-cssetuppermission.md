...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398428(v=OCS.15)
ms:contentKeyID: 49297366
ms.date: 05/20/2016
...
Verifies that the required permissions needed to install Lync Server or one of its components have been configured on the specified Active Directory container. Cette applet de commande est une nouveauté de Lync Server 2010.
