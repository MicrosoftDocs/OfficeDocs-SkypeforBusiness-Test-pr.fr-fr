...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398365(v=OCS.15)
ms:contentKeyID: 49297226
ms.date: 05/20/2016
...
Creates a new network site for use with call admission control (CAC) or Enhanced 9-1-1 (E9-1-1). Cette applet de commande est une nouveauté de Lync Server 2010.
