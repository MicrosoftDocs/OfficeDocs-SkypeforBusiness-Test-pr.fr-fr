...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398262(v=OCS.15)
ms:contentKeyID: 49296440
ms.date: 05/20/2016
...
Returns information about the client personal identification number (PIN) policies configured for use in your organization. PIN authentication enables users to access Lync Server by providing a PIN instead of a user name and password. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Retrieves the PIN policy data from the local replica of the magasin central de gestion rather than from the magasin central de gestion itself.</p></td>
</tr>
</tbody>
</table>
