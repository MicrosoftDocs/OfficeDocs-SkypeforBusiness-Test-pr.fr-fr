...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398070(v=OCS.15)
ms:contentKeyID: 49296059
ms.date: 05/20/2016
...
Returns information regarding management options for Lync Phone Edition. This includes such things as the required security mode and whether or not the phone should automatically be locked after a specified period of inactivity. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Retrieves the UC phone configuration data from the local replica of the magasin central de gestion rather than from the magasin central de gestion itself.</p></td>
</tr>
</tbody>
</table>
