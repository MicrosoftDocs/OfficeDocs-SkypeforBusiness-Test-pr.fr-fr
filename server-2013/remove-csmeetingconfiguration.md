...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412775(v=OCS.15)
ms:contentKeyID: 49298438
ms.date: 05/20/2016
...
<td><p>Globally unique identifier (GUID) of the Skype Entreprise Online tenant account for the meeting configuration settings being deleted. For example:</p>
