...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205247(v=OCS.15)
ms:contentKeyID: 49298766
ms.date: 05/20/2016
...
Manually purges records from the Quality of Experience (QoE) database. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Invoke-CsQoEDatabasePurge** cmdlet are not available in the Panneau de configuration Lync Server.
