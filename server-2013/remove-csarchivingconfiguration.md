...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398951(v=OCS.15)
ms:contentKeyID: 49299010
ms.date: 05/20/2016
...
Removes the specified collection of archiving settings. Archiving settings are used to enable or disable the automatic saving of instant messaging (IM) sessions, and to optionally block any instant message that cannot be archived. Cette applet de commande est une nouveauté de Lync Server 2010.
