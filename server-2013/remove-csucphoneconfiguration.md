...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398249(v=OCS.15)
ms:contentKeyID: 49296408
ms.date: 05/20/2016
...
Removes the specified collection of Lync Phone Edition configuration settings. These settings include such things as the required security mode and whether the phone should automatically be locked after a specified period of inactivity. Cette applet de commande est une nouveauté de Lync Server 2010.
