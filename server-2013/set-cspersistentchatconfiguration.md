...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205122(v=OCS.15)
ms:contentKeyID: 49298197
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** To modify an existing collection of Persistent Chat configuration settings using the Panneau de configuration Lync Server, click **Persistent Chat**, click **Persistent Chat Configuration**, then double-click the collection to be modified.
