...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204911(v=OCS.15)
ms:contentKeyID: 49297301
ms.date: 05/20/2016
...
Modifies one or more centralized logging search terms. Search terms help define the personally identifiable information available to technical support personnel who are searching the centralized trace logs. Search terms are intended for use with Skype Entreprise Online.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Set-CsClsSearchTerm** cmdlet are not available in the Panneau de configuration Lync Server.
