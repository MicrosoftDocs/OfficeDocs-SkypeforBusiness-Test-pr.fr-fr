...
TOCTitle: Définition de la configuration requise pour les appels d’urgence
ms:assetid: 5c12b517-9be6-41d0-83e2-11c78793620c
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398404(v=OCS.15)
ms:contentKeyID: 49297336
ms.date: 05/20/2016
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Définition de la configuration requise pour les appels d’urgence dans Lync Server 2013

 

_**Dernière rubrique modifiée :** 2015-03-09_

Avant de commencer un déploiement E9-1-1 Microsoft Lync Server 2013, vous devez d’abord répondre aux questions décrites en détail dans les sections suivantes. La planification dont vous avez besoin dépend du type de solution E9-1-1 que vous choisissez de déployer : fournisseur de services E9-1-1 de jonction SIP ou numéro ELIN (Emergency Location Identification Number). Le tableau ci-dessous identifie les sections du document de planification que vous devez consulter pour chacune de ces solutions.
...
<tr class="even">
<td><p><a href="lync-server-2013-managing-locations-for-sip-trunk-service-providers.md">Gestion des emplacements pour les fournisseurs de service de jonction SIP dans Lync Server 2013</a></p></td>
...
<td><p><a href="lync-server-2013-including-the-security-desk.md">Intégration du service de sécurité dans Lync Server 2013</a></p></td>
</tr>
<tr class="odd">
<td><p><a href="lync-server-2013-including-the-security-desk.md">Intégration du service de sécurité dans Lync Server 2013</a></p></td>
...
<tr class="even">
<td><p><a href="lync-server-2013-choosing-an-e9-1-1-service-provider.md">Sélection d’un fournisseur de services E9-1-1 pour Lync Server 2013</a></p></td>
...
## Dans cette section
  ...
  - [Gestion des emplacements pour les fournisseurs de service de jonction SIP dans Lync Server 2013](lync-server-2013-managing-locations-for-sip-trunk-service-providers.md)
  ...
  - [Intégration du service de sécurité dans Lync Server 2013](lync-server-2013-including-the-security-desk.md)
