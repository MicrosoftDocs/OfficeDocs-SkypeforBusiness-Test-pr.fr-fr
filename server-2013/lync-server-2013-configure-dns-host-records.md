...
5.  Cliquez sur **Adresse IP** et tapez l’adresse IP virtuelle (VIP) du programme d’équilibrage de la charge pour le pool de serveurs frontaux.
    ...
    <tbody>
    <tr class="odd">
    <td>Dans les déploiements qui utilisent un pool directeur, les enregistrements hôtes (A) pour les URL simples doivent pointer sur l’adresse IP virtuelle du programme d’équilibrage de la charge du directeur.</td>
    </tr>
    </tbody>
    </table>
