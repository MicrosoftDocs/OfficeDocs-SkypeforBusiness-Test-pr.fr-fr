...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425857(v=OCS.15)
ms:contentKeyID: 49296886
ms.date: 05/20/2016
...
Creates a new SIP domain for use in your organization. SIP domains are domains authorized to send and receive SIP traffic, and are used when assigning SIP addresses to users. Cette applet de commande est une nouveauté de Lync Server 2010.
