...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398682(v=OCS.15)
ms:contentKeyID: 49297968
ms.date: 05/20/2016
...
Forces the back-end user database to clear its replication status with Active Directory. This causes the database to re-read all the user-related information stored in services de domaine Active Directory. Cette applet de commande est une nouveauté de Lync Server 2010.
