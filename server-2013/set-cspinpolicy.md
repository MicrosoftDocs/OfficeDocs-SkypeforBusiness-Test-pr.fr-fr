...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412997(v=OCS.15)
ms:contentKeyID: 49299311
ms.date: 05/20/2016
...
Modifies one or more existing client personal identification number (PIN) policies. PIN authentication enables users to access Lync Server by providing a PIN instead of a user name and password. Cette applet de commande est une nouveauté de Lync Server 2010.
