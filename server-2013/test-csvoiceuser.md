...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg413013(v=OCS.15)
ms:contentKeyID: 49299333
ms.date: 05/20/2016
...
Identifies the route that a phone call from a given user would take to be completed based on voice rules, routes, and policies. Cette applet de commande est une nouveauté de Lync Server 2010.
