...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398905(v=OCS.15)
ms:contentKeyID: 49298920
ms.date: 05/20/2016
...
Creates a new client version policy rule. Client version policy rules help determine whether users can use a specific client application to log on to Lync Server. Cette applet de commande est une nouveauté de Lync Server 2010.
