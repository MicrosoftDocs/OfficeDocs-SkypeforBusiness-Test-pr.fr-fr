...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398245(v=OCS.15)
ms:contentKeyID: 49296410
ms.date: 05/20/2016
...
Modifies an existing collection of QoE (Quality of Experience) settings. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<p>Note that even if EnableQoE is set to True, QoE data will not be collected unless a serveur de surveillance has been deployed and associated with a Registrar pool.</p></td>
</tr>
<tr class="odd">
