...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204784(v=OCS.15)
ms:contentKeyID: 49296747
ms.date: 05/20/2016
...
Verifies that a test user can connect to Exchange Unified Messaging. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Test-CsExUMConnectivity** cmdlet are not available in the Panneau de configuration Lync Server.
