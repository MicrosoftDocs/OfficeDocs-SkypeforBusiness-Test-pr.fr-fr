...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412747(v=OCS.15)
ms:contentKeyID: 49298352
ms.date: 05/20/2016
...
Creates a new presence policy at either the site scope or the per-user scope. Cette applet de commande est une nouveauté de Lync Server 2010.
