...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205331(v=OCS.15)
ms:contentKeyID: 49299016
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** The functions carried out by the **Test-CsExStorageNotification** cmdlet are not available in the Panneau de configuration Lync Server.
