...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398911(v=OCS.15)
ms:contentKeyID: 49298945
ms.date: 05/20/2016
...
Returns information about how (or if) the Enhanced 9-1-1 (E9-1-1) service d’informations sur l’emplacement has been configured. The E9-1-1 service enables those who answer emergency calls to determine the caller’s geographic location. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Retrieves the location policy information from the local replica of the magasin central de gestion, rather than the magasin central de gestion itself.</p></td>
</tr>
</tbody>
</table>
