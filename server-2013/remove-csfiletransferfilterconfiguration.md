...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg413064(v=OCS.15)
ms:contentKeyID: 49299423
ms.date: 05/20/2016
...
Removes the specified instant message file transfer filter configuration. (Instant message file transfer filter settings are used to block a user’s ability to transfer certain types of files within an instant message.) Cette applet de commande est une nouveauté de Lync Server 2010.
