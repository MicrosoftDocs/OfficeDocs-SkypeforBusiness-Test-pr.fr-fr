...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398431(v=OCS.15)
ms:contentKeyID: 49297374
ms.date: 05/20/2016
...
Removes the specified personal identification number (PIN) policy. PIN authentication and PIN policies enable users to access Lync Server by providing a PIN instead of a user name and password. Cette applet de commande est une nouveauté de Lync Server 2010.
