...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205192(v=OCS.15)
ms:contentKeyID: 49298614
ms.date: 05/20/2016
...
Modifies an existing Persistent Chat policy. Persistent Chat policies determine whether or not users are allowed access to Persistent Chat chat rooms. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** To modify an existing Persistent Chat policy using the Panneau de configuration Lync Server, click **Persistent Chat**, click **Persistent Chat Policy**, then double-click the policy to be modified.
