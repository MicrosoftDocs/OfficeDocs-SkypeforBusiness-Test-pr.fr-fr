...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204711(v=OCS.15)
ms:contentKeyID: 49296385
ms.date: 05/20/2016
...
Removes an existing collection of reporting configuration settings. Reporting configuration settings are used to specify the URL for installations of Lync Server 2013 Monitoring Reports. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Remove-CsReportingConfiguration** cmdlet are not available in the Panneau de configuration Lync Server.
