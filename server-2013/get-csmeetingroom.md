...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205277(v=OCS.15)
ms:contentKeyID: 49298863
ms.date: 05/20/2016
...
Returns information about all the Lync Server 2013 meeting rooms configured for use in the organization. A meeting room is a conferencing device designed to address video conferencing and collaboration scenarios in small conference rooms. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Get-CsMeetingRoom** cmdlet are not available in the Panneau de configuration Lync Server.
