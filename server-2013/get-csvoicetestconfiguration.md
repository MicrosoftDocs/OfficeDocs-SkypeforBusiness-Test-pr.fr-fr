...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412957(v=OCS.15)
ms:contentKeyID: 49298763
ms.date: 05/20/2016
...
Retrieves a test scenario you can use to test phone numbers against specified routes and rules. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Retrieves the voice test configuration from the local replica of the magasin central de gestion, rather than the magasin central de gestion itself.</p></td>
</tr>
</tbody>
</table>
