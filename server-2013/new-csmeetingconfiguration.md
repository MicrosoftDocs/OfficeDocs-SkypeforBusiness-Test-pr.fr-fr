...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398065(v=OCS.15)
ms:contentKeyID: 49296051
ms.date: 05/20/2016
...
<td><p>Globally unique identifier (GUID) of the Skype Entreprise Online tenant account for which the new meeting configuration settings are being created. For example:</p>
