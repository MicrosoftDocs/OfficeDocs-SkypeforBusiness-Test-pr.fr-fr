...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204668(v=OCS.15)
ms:contentKeyID: 49296236
ms.date: 05/20/2016
...
Replaces one or more Persistent Chat messages in the Persistent Chat database with a default message or with an administrator-provided message. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Remove-CsPersistentChatMessage** cmdlet are not available in the Panneau de configuration Lync Server.
