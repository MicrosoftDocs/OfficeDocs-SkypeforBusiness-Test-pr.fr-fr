...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398659(v=OCS.15)
ms:contentKeyID: 49297915
ms.date: 05/20/2016
...
Locates each server running services web in a site that has been assigned a Kerberos account, and then updates the Internet Information Services (IIS) configuration settings on each of those servers. Cette applet de commande est une nouveauté de Lync Server 2010.
