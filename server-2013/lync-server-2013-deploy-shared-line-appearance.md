...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Mt712152(v=OCS.15)
ms:contentKeyID: 72522153
ms.date: 06/14/2016
...
_**Dernière rubrique modifiée :** 2016-06-13_
...
2.  Add delegates to the group by using the [Add-CsSlaDelegates](https://docs.microsoft.com/en-us/powershell/module/skype/add-cssladelegates) cmdlet:
    ...
    The following example adds a user to the SLA group. Each user added to the group must be a valid Voix Entreprise-enabled user:
