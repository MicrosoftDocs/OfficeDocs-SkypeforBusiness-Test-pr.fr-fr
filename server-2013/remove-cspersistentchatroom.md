...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204639(v=OCS.15)
ms:contentKeyID: 49296113
ms.date: 05/20/2016
...
Removes one or more Persistent Chat chat rooms. A chat room is a discussion forum that typically revolves around a specific topic. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** To delete an existing Persistent Chat chat room using the Panneau de configuration Lync Server, click **Persistent Chat**, click **Room**, and then select the room to be deleted. To delete the room, click **Edit**, and then click **Delete**.
