...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412792(v=OCS.15)
ms:contentKeyID: 49298481
ms.date: 05/20/2016
...
Retrieves one or more ranges of unassigned numbers and the routing rules that apply to those numbers. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Retrieves the unassigned number information from the local replica of the magasin central de gestion, rather than the magasin central de gestion itself.</p></td>
</tr>
</tbody>
</table>
