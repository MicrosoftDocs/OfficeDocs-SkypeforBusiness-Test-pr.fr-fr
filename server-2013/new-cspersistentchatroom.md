...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205166(v=OCS.15)
ms:contentKeyID: 49298559
ms.date: 05/20/2016
...
Creates a new Persistent Chat chat room. A chat room is a discussion forum that typically revolves around a specific topic. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** To create a new Persistent Chat chat room using the Panneau de configuration Lync Server, click **Persistent Chat**, click **Room**, and then click **New**.
