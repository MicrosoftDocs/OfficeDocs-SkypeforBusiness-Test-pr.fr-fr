...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398871(v=OCS.15)
ms:contentKeyID: 49298864
ms.date: 05/20/2016
...
Assigns a client personal identification number (PIN) policy to a user or group of users. PIN authentication enables users to access Lync Server by providing a PIN instead of a user name and password. Cette applet de commande est une nouveauté de Lync Server 2010.
