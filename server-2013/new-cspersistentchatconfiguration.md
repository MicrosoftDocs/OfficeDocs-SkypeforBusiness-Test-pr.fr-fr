...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205330(v=OCS.15)
ms:contentKeyID: 49299073
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** To create a new collection of Persistent Chat configuration settings using the Panneau de configuration Lync Server, click **Persistent Chat**, click **Persistent Chat Configuration**, click **New**, and then click either **Site configuration** or **Pool configuration**.
