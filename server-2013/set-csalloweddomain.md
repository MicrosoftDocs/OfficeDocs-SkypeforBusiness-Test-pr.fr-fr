...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398931(v=OCS.15)
ms:contentKeyID: 49298970
ms.date: 05/20/2016
...
<td><p>Indicates whether the federation connection between your domain and the remote domain will be monitored by serveur de surveillance. By default, MarkForMonitoring is set to False, meaning that the connection will not be monitored.</p>
<p>This property will be ignored if you have not deployed serveur de surveillance.</p></td>
</tr>
<tr class="odd">
