...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg413065(v=OCS.15)
ms:contentKeyID: 49299425
ms.date: 05/20/2016
...
Creates a new Response Group agent group. An agent group is a collection of agents assigned to a Response Group queue. Agents are the users assigned to answer calls directed to a particular queue. Cette applet de commande est une nouveauté de Lync Server 2010.
