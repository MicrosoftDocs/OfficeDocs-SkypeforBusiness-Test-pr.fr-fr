...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412869(v=OCS.15)
ms:contentKeyID: 49298596
ms.date: 05/20/2016
...
Enables you to modify configuration settings for computers running the service Edge A/V (these computers are also known as A/V Edge servers). An A/V Edge server enables internal users to share audio and video data with external users (that is, users who are not logged on to your internal network), as well as exchange files and participate in desktop sharing sessions. Cette applet de commande est une nouveauté de Lync Server 2010.
