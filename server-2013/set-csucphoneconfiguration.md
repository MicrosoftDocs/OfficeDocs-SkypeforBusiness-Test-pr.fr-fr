...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg413042(v=OCS.15)
ms:contentKeyID: 49299368
ms.date: 05/20/2016
...
Enables you to modify management options for Lync Phone Edition. This includes such things as the required security mode and whether or not the phone should automatically be locked after a specified period of inactivity. Cette applet de commande est une nouveauté de Lync Server 2010.
