...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425845(v=OCS.15)
ms:contentKeyID: 49296854
ms.date: 05/20/2016
...
Modifies an existing Response Group workflow. Workflows determine the actions that are taken when the application Response Group receives a phone call. Cette applet de commande est une nouveauté de Lync Server 2010.
