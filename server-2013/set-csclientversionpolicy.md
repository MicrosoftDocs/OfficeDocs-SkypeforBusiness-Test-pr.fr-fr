...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398876(v=OCS.15)
ms:contentKeyID: 49298884
ms.date: 05/20/2016
...
Modifies an existing client version policy. Client version policies enable you to specify which clients (such as Microsoft Office Communicator 2007 R2) will be allowed to log on to your Lync Server system. Cette applet de commande est une nouveauté de Lync Server 2010.
