...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398574(v=OCS.15)
ms:contentKeyID: 49297766
ms.date: 05/20/2016
...
Returns information about the configuration settings for computers running the service Edge d’accès in your organization (also known as Access Edge servers). Access Edge servers provide a way for users outside your internal network to communicate with users inside your internal network. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Retrieves the Access Edge configuration data from the local replica of the magasin central de gestion rather than from the magasin central de gestion itself.</p></td>
</tr>
</tbody>
</table>
