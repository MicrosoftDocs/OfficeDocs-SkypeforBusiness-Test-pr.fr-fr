...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205227(v=OCS.15)
ms:contentKeyID: 49298728
ms.date: 05/20/2016
...
Tests the ability of a pair of users to take part in an application sharing conference. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the Test-CsASConference cmdlet are not available in the Panneau de configuration Lync Server.
