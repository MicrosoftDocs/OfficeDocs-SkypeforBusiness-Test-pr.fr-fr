...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398501(v=OCS.15)
ms:contentKeyID: 49297501
ms.date: 05/20/2016
...
Removes a voice normalization rule. Voice normalization rules are used to convert telephone dialing requirements (for example, dialing 9 to access an outside line) to the E.164 phone number format used by Lync Server. Cette applet de commande est une nouveauté de Lync Server 2010.
