...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205396(v=OCS.15)
ms:contentKeyID: 49299377
ms.date: 05/20/2016
...
Creates a new Persistent Chat policy at the site or the per-user scope. Persistent Chat policies determine whether or not users are allowed access to Persistent Chat chat rooms. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** To create a new Persistent Chat policy using the Panneau de configuration Lync Server, click **Persistent Chat**, click **Persistent Chat Policy**, click **New**, and then click either **Site policy** or **User policy**.
