...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205072(v=OCS.15)
ms:contentKeyID: 49298026
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** The functions carried out by the **New-CsUserServicesPolicy** cmdlet are not available in the Panneau de configuration Lync Server.
...
<td><p>Globally unique identifier (GUID) of the Skype Entreprise Online tenant account for which the new user services policy is being created. For example:</p>
