...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg399040(v=OCS.15)
ms:contentKeyID: 49299233
ms.date: 05/20/2016
...
Creates a new Response Group time range. Time ranges are used by the application Response Group to specify opening and closing times for a business day. For example, if your help desk agents are available only from 12:00 P.M. to 5:00 P.M. on Sundays, then you would create a time range for Sunday that had an opening time of 12:00 P.M. and a closing time of 5:00 P.M. Cette applet de commande est une nouveauté de Lync Server 2010.
