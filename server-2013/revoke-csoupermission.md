...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398977(v=OCS.15)
ms:contentKeyID: 49299062
ms.date: 05/20/2016
...
Revokes the Lync Server management permissions that have been granted on an Active Directory organizational unit (OU). Cette applet de commande est une nouveauté de Lync Server 2010.
