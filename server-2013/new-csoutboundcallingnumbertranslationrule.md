...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205097(v=OCS.15)
ms:contentKeyID: 49298126
ms.date: 05/20/2016
...
Creates a new outbound calling number translation rule. An outbound calling number translation rule converts the E.164 phone numbers used by Lync Server 2013 to a format that can be used by trunking peers that do not support E.164 numbers. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** To create a new outbound calling number translation rule using the Panneau de configuration Lync Server, click Voice Routing then click Trunk Configuration, and then double-click the appropriate item in the Name column. In the Edit Trunk Configuration dialog box scroll down to the section labeled Calling number translation rules and then click New.
