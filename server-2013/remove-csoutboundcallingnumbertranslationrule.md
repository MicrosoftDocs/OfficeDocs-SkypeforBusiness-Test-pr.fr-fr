...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204836(v=OCS.15)
ms:contentKeyID: 49297015
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** To remove an outbound calling number translation rule using the Panneau de configuration Lync Server, click Voice Routing and then click Trunk Configuration. Double-click the appropriate item in the Name column and then, in the Edit Trunk Configuration dialog box, scroll down to the section labeled Calling number translation roles. Select the rule to be deleted, and then click Remove.
