...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398441(v=OCS.15)
ms:contentKeyID: 49297402
ms.date: 05/20/2016
...
Enables you to create a new external access policy. External access policies determine whether or not your users can: 1) communicate with users who have Session Initiation Protocol (SIP) accounts with a federated organization; 2) communicate with users who have SIP accounts with a public instant messaging (IM) provider such as MSN; and, 3) access Lync Server over the Internet, without having to log on to your internal network. Cette applet de commande est une nouveauté de Lync Server 2010.
