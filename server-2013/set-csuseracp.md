...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg413018(v=OCS.15)
ms:contentKeyID: 49299343
ms.date: 05/20/2016
...
Adds a new audio conferencing provider to a user or group of users, or modifies an existing audio conferencing provider already assigned to a user. Cette applet de commande est une nouveauté de Lync Server 2010.
