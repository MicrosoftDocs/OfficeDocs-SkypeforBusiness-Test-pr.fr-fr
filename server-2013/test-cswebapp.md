...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Hh689989(v=OCS.15)
ms:contentKeyID: 49296086
ms.date: 05/20/2016
...
Verifies that authenticated users can use Lync Web App to join a Lync Server conference. Cette applet de commande est une nouveauté de Lync Server 2010.
