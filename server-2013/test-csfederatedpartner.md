...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398281(v=OCS.15)
ms:contentKeyID: 49296474
ms.date: 05/20/2016
...
Verifies the ability to connect to a federated domain. Cette applet de commande est une nouveauté de Lync Server 2010.
