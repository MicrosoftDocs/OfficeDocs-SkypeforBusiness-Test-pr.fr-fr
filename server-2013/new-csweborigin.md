...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ950236(v=OCS.15)
ms:contentKeyID: 53095365
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** The functions carried out by the **New-CsWebOrigin** cmdlet are not available in the Panneau de configuration Lync Server.
