...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204904(v=OCS.15)
ms:contentKeyID: 49297294
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** The functions carried out by the Get-CsFIPSConfiguration cmdlet are not available in the Panneau de configuration Lync Server.
...
<td><p>Globally unique identifier (GUID) of the Skype Entreprise Online tenant account whose FIPS configuration settings are to be retrieved.</p>
<p>For example:</p>
