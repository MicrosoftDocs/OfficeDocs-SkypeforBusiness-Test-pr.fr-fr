...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Hh690013(v=OCS.15)
ms:contentKeyID: 49296937
ms.date: 05/20/2016
...
<td><p>Globally unique identifier (GUID) of the Skype Entreprise Online tenant account for the push notification settings being modified. For example:</p>
