...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398815(v=OCS.15)
ms:contentKeyID: 49298776
ms.date: 05/20/2016
...
Retrieves the voice configuration object, which contains a full list of all voice test configurations defined for the Lync Server deployment. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Retrieves the voice configuration from the local replica of the magasin central de gestion, rather than the magasin central de gestion itself.</p></td>
</tr>
</tbody>
</table>
