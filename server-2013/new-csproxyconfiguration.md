...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398335(v=OCS.15)
ms:contentKeyID: 49297197
ms.date: 05/20/2016
...
Creates a new collection of proxy configuration settings. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Optional</p></td>
<td><p>System.Boolean</p></td>
<td><p>When set to True, the proxy server functions as if all client connections are external connections that pass through the serveur Edge running the service Edge d’accès. The default value is False.</p></td>
</tr>
<tr class="odd">
