...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg413041(v=OCS.15)
ms:contentKeyID: 49299398
ms.date: 05/20/2016
...
Creates a new SIP response code translation rule. These rules enable administrators to map SIP response codes with values between 400 and 699 to the values used by Lync Server. Cette applet de commande est une nouveauté de Lync Server 2010.
