...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398709(v=OCS.15)
ms:contentKeyID: 49298021
ms.date: 05/20/2016
...
Creates a new client version policy. Client version policies enable you to specify which versions of clients (such as Microsoft Office Communicator 2007 R2) will be able to log on to your Lync Server system. Cette applet de commande est une nouveauté de Lync Server 2010.
