...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204879(v=OCS.15)
ms:contentKeyID: 49297181
ms.date: 05/20/2016
...
Returns information about the centralized logging configuration regions in use in the organization. Centralized logging provides a way for administrators to simultaneously enable or disable event tracing on multiple computers. Centralized logging regions are intended for use with Skype Entreprise Online.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Get-CsClsRegion** cmdlet are not available in the Panneau de configuration Lync Server.
