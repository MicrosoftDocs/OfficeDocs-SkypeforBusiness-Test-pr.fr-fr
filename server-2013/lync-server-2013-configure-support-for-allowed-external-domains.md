...
5.  Dans **Nouveaux domaines fédérés** , procédez comme suit :
      ...
      - Dans **Nom de domaine complet (ou FQDN)** , tapez le nom de domaine du partenaire fédéré.
        ...
        <tbody>
        <tr class="odd">
        <td>Ce nom doit être unique et ne doit pas déjà exister en tant que domaine autorisé pour ce serveur exécutant le service Edge d’accès. Il peut contenir jusqu’à 256 caractères.<br />
        ...
        Un domaine de partenaire fédéré ne peut pas être simultanément bloqué et autorisé. Lync Server 2013 empêche cette situation afin que vous n’ayez pas à synchroniser vos listes.</td>
        </tr>
        </tbody>
        </table>
