...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398486(v=OCS.15)
ms:contentKeyID: 49297474
ms.date: 05/20/2016
...
Creates a new workflow prompt for the application Response Group. A workflow prompt is either an audio file that is played or text that is read aloud in order to supply callers with additional information. Cette applet de commande est une nouveauté de Lync Server 2010.
