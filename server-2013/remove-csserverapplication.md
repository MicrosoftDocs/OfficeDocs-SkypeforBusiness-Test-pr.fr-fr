...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398366(v=OCS.15)
ms:contentKeyID: 49297228
ms.date: 05/20/2016
...
Removes an existing server application. Server applications are applications that are hosted by Lync Server. Cette applet de commande est une nouveauté de Lync Server 2010.
