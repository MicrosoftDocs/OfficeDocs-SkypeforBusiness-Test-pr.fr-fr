...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205109(v=OCS.15)
ms:contentKeyID: 49298339
ms.date: 05/20/2016
...
Modifies the state of a Persistent Chat service pool. Persistent Chat pools can be in one of two states: Normal, in which the pool uses its primary databases; or FailedOver, in which the pool uses the backup databases defined in the topology. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Set-CsPersistentChatState** cmdlet are not available in the Panneau de configuration Lync Server.
