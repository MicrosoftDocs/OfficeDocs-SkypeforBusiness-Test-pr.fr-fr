...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412967(v=OCS.15)
ms:contentKeyID: 49298779
ms.date: 05/20/2016
...
<td><p>Indicates the maximum amount of bandwidth (in megabytes) set aside for the service de conférence de partage d’applications. MaxBandwidthPerAppSharingServiceMb can be set to any integer value between 50 and 100000, inclusive. The default value is 375 megabytes.</p></td>
</tr>
<tr class="even">
