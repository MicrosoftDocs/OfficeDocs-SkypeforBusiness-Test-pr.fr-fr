...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398655(v=OCS.15)
ms:contentKeyID: 49297917
ms.date: 05/20/2016
...
Retrieves endpoints for the service d’application. Cette applet de commande est une nouveauté de Lync Server 2010.
...
This cmdlet retrieves one or more application contacts from services de domaine Active Directory. These objects are stored in Active Directory in the Application Contacts container of the RTC service.
