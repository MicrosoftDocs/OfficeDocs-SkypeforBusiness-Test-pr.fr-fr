...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425851(v=OCS.15)
ms:contentKeyID: 49296872
ms.date: 05/20/2016
...
Retrieves the routing configuration object, which contains a list of all voice routes defined within a Lync Server deployment. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Retrieves the routing configuration from the local replica of the magasin central de gestion, rather than the magasin central de gestion itself.</p></td>
</tr>
</tbody>
</table>
