...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398580(v=OCS.15)
ms:contentKeyID: 49297758
ms.date: 05/20/2016
...
Modifies an existing collection of media settings. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Optional</p></td>
<td><p>System.Boolean</p></td>
<td><p>By default, the serveur de médiation does not negotiate Siren as a possible codec for calls between itself and other Lync clients. If this setting is True, Siren will be included as a possible codec for use between the serveur de médiation and other Lync clients.</p></td>
</tr>
<tr class="even">
