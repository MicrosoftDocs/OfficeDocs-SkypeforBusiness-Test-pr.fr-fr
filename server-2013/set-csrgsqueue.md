...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412947(v=OCS.15)
ms:contentKeyID: 49298724
ms.date: 05/20/2016
...
Modifies an existing Response Group queue. With the application Response Group, phone calls are put in a queue and callers are placed on hold until a Response Group agent is available to answer that call. Cette applet de commande est une nouveauté de Lync Server 2010.
