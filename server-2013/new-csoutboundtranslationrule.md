...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412803(v=OCS.15)
ms:contentKeyID: 49298473
ms.date: 05/20/2016
...
Creates a new outbound translation rule. An outbound translation rule converts phone numbers to the local dialing format for interaction with private branch exchange (PBX) systems. Cette applet de commande est une nouveauté de Lync Server 2010.
