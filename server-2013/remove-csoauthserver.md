...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205408(v=OCS.15)
ms:contentKeyID: 49299413
ms.date: 05/20/2016
...
Removes an existing Open Authorization (OAuth) server. OAuth servers, also known as security token servers, issue security tokens used in server-to-server authentication and authorization. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Remove-CsOAuthServer** cmdlet are not available in the Panneau de configuration Lync Server.
...
<td><p>Globally unique identifier (GUID) of the Skype Entreprise Online tenant account for the OAuth server being deleted. For example:</p>
