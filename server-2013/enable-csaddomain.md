...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412764(v=OCS.15)
ms:contentKeyID: 49298420
ms.date: 05/20/2016
...
Modifies the security settings on the universal groups created during forest preparation. These modifications provide the permissions needed to host and manage users enabled for Lync Server within the domain. Cette applet de commande est une nouveauté de Lync Server 2010.
