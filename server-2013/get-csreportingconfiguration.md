...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205356(v=OCS.15)
ms:contentKeyID: 49299172
ms.date: 05/20/2016
...
Returns information about the reporting configuration settings in use in the organization. Reporting configuration settings are used to specify the URL used for accessing Lync Server 2013 Monitoring Reports. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Get-CsReportingConfiguration** cmdlet are not available in the Panneau de configuration Lync Server.
