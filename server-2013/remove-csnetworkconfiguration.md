...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398938(v=OCS.15)
ms:contentKeyID: 49298986
ms.date: 05/20/2016
...
Resets all the network configuration settings for a Lync Server deployment to the default values. This deletes an entire call admission control (CAC) deployment and related E9-1-1 configuration. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Vous demande confirmation avant d’exécuter la commande. It is recommended that you always use this parameter with this cmdlet.</p></td>
</tr>
<tr class="odd">
