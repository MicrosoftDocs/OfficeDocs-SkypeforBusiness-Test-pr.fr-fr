...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204686(v=OCS.15)
ms:contentKeyID: 49296318
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** To edit the property values for an existing XMPP allowed partner using the Panneau de configuration Lync Server, click External User Access, click XMPP Federated Partners, and then double-click the partner to be modified.
