...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398348(v=OCS.15)
ms:contentKeyID: 49297233
ms.date: 05/20/2016
...
Retrieves a hosted voice mail policy. Cette applet de commande est une nouveauté de Lync Server 2010.
...
This cmdlet retrieves a policy that specifies how to route unanswered calls to a user to a hosted messagerie unifiée Exchange service.
...
<td><p>Retrieves the hosted voice mail policy from the local replica of the magasin central de gestion, rather than the magasin central de gestion itself.</p></td>
</tr>
<tr class="even">
<td><p><em>Tenant</em></p></td>
<td><p>Optional</p></td>
<td><p>System.Guid</p></td>
<td><p>Globally unique identifier (GUID) of the Skype Entreprise Online tenant account whose voicemail policy is to be retrieved.</p>
<p>For example:</p>
