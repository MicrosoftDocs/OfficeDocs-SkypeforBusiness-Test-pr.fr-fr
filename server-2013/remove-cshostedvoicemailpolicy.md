...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398211(v=OCS.15)
ms:contentKeyID: 49296328
ms.date: 05/20/2016
...
Removes a hosted voice mail policy. Cette applet de commande est une nouveauté de Lync Server 2010.
...
This cmdlet removes a policy that specifies how to route unanswered calls to the user to a hosted messagerie unifiée Exchange service.
...
<td><p>Globally unique identifier (GUID) of the Skype Entreprise Online tenant account for the hosted voicemail policy being deleted. For example:</p>
