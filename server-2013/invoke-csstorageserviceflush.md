...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ619175(v=OCS.15)
ms:contentKeyID: 49296997
ms.date: 05/20/2016
...
Flushes the Lync Server Storage Service database on each Front End server in a pool. Flushing a database involves writing all the queued data to disk, and then clearing the database queue. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Invoke-CsStorageServiceFlush** cmdlet are not available in the Panneau de configuration Lync Server.
