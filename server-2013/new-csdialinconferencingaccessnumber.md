...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398818(v=OCS.15)
ms:contentKeyID: 49298789
ms.date: 05/20/2016
...
Creates a new dial-in conferencing access number. Dial-in conferencing provides a way for users to use a "regular" telephone, cell phone or other device on the public switched telephone network (PSTN) to join the audio portion of a conference. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Globally unique identifier (GUID) of the Skype Entreprise Online tenant account for which the new dial-in conferencing access number is being created. For example:</p>
