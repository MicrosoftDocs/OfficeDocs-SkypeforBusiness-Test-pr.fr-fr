...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204709(v=OCS.15)
ms:contentKeyID: 49296375
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** The functions carried out by the **Import-CsPersistentChatData** cmdlet are not available in the Panneau de configuration Lync Server.
