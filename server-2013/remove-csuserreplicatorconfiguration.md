...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425738(v=OCS.15)
ms:contentKeyID: 49296659
ms.date: 05/20/2016
...
Removes the specified collection of User Replicator configuration settings. The User Replicator periodically retrieves up-to-date user account information from Active Directory and then synchronizes the new information with the current user data stored by Lync Server. Cette applet de commande est une nouveauté de Lync Server 2010.
