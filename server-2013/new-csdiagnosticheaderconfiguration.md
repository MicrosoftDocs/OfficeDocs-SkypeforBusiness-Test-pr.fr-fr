...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398350(v=OCS.15)
ms:contentKeyID: 49297244
ms.date: 05/20/2016
...
Creates a new diagnostic header configuration setting collection. Diagnostic header configuration settings determine whether SIP messages are accompanied by header information that can be useful in troubleshooting and error reporting. Cette applet de commande est une nouveauté de Lync Server 2010.
