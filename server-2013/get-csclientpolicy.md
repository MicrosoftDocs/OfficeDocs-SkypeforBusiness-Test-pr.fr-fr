...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398830(v=OCS.15)
ms:contentKeyID: 49298811
ms.date: 05/20/2016
...
Returns information about the client policies configured for use in your organization. Among other things, client policies help determine the features of Lync that are available to users; for example, you might give some users the right to transfer files while denying this right to other users. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Retrieves the client policy data from the local replica of the magasin central de gestion rather than from the magasin central de gestion itself.</p></td>
</tr>
</tbody>
</table>
