...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412852(v=OCS.15)
ms:contentKeyID: 49298544
ms.date: 05/20/2016
...
Verifies that a user can log on to Lync Server using a Lync Phone Edition-compatible device. Cette applet de commande est une nouveauté de Lync Server 2010.
