...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204838(v=OCS.15)
ms:contentKeyID: 49297023
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** The functions carried out by the **Get-CsUserServicesPolicy** cmdlet are not available in the Panneau de configuration Lync Server.
...
<td><p>When used, retrieves the user services policy for the specified Skype Entreprise Online tenant. For example:</p>
