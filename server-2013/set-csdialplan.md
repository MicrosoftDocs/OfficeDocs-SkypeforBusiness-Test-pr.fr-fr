...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398644(v=OCS.15)
ms:contentKeyID: 49297879
ms.date: 05/20/2016
...
Modifies an existing dial plan. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Permet de transmettre une référence à un objet à la cmdlet plutôt que de définir des valeurs de paramètre individuelles. You can retrieve this object reference by calling the <strong>Get-CsDialPlan</strong> cmdlet.</p></td>
</tr>
<tr class="even">
