...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425761(v=OCS.15)
ms:contentKeyID: 49296697
ms.date: 05/20/2016
...
<td><p>Indicates the valid log file extensions that can be used with the service web de mise à jour des périphériques. This list can be modified; however, there is no reason to modify the list unless you have a device running Lync Server that creates log files that use a different file extension.</p>
