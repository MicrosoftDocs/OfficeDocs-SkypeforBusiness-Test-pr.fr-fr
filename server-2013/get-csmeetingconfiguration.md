...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425875(v=OCS.15)
ms:contentKeyID: 49296933
ms.date: 05/20/2016
...
<td><p>Retrieves the meeting configuration data from the local replica of the magasin central de gestion rather than from the magasin central de gestion itself.</p></td>
</tr>
<tr class="even">
