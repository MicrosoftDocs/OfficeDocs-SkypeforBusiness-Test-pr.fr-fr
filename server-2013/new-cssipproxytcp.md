...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425745(v=OCS.15)
ms:contentKeyID: 49296651
ms.date: 05/20/2016
...
Creates a new SipProxy.TCP object, which can then be used to configure a static route to use Transmission Control Protocol (TCP) as its transport protocol. Cette applet de commande est une nouveauté de Lync Server 2010.
