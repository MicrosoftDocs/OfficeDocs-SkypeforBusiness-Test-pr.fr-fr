...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204891(v=OCS.15)
ms:contentKeyID: 49297218
ms.date: 05/20/2016
...
Returns the eligible principals for a Persistent Chat category or chat room. Eligible principals include allowed members or managers (for a category of chat room) as well as allowed presenters (chat room only). Cette applet de commande est une nouveauté de Lync Server 2013.
...
Panneau de configuration Lync Server: The functions carried out by the **Get-CsPersistentChatEligiblePrincipal** cmdlet are not available in the Panneau de configuration Lync Server.
