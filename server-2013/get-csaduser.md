...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398592(v=OCS.15)
ms:contentKeyID: 49297785
ms.date: 05/20/2016
...
Returns information about all the user accounts in services de domaine Active Directory. This includes user accounts that have been enabled for Lync Server as well as accounts that have not been enabled for Lync Server. Cette applet de commande est une nouveauté de Lync Server 2010.
