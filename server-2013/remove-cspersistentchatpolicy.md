...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205301(v=OCS.15)
ms:contentKeyID: 49298990
ms.date: 05/20/2016
...
Removes an existing Persistent Chat policy. Persistent Chat policies determine whether or not users are allowed access to Persistent Chat chat rooms. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** To remove a Persistent Chat policy using the Panneau de configuration Lync Server, click **Persistent Chat** and then click **Persistent Chat Policy**. Select the policy to be removed, click **Edit**, and then click **Delete**.
