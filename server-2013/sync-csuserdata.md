...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205242(v=OCS.15)
ms:contentKeyID: 49298749
ms.date: 05/20/2016
...
Synchronizes user data between a pair of Lync Server 2013 pools. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Sync-CsUserData** cmdlet are not available in the Panneau de configuration Lync Server.
