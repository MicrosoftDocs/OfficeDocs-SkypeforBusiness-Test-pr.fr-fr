...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412942(v=OCS.15)
ms:contentKeyID: 49298745
ms.date: 05/20/2016
...
Assigns a client policy to a user or a group of users. Among other things, client policies help determine the features of Lync Server that are available to users; for example, you might give some users the right to transfer files while denying this right to other users. Cette applet de commande est une nouveauté de Lync Server 2010.
