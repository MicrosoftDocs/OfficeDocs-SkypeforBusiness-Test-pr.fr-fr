...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425814(v=OCS.15)
ms:contentKeyID: 49296790
ms.date: 05/20/2016
...
Enables you to assign an existing certificate to a SipProxy.TLS object. In turn, that object can be used configure a static route to use Transport Layer Security (TLS) as its transport protocol. Cette applet de commande est une nouveauté de Lync Server 2010.
