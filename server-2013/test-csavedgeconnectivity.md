...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205138(v=OCS.15)
ms:contentKeyID: 49298342
ms.date: 05/20/2016
...
Verifies connectivity through the A/V Edge server. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Test-CsAVEdgeConnectivity** cmdlet are not available in the Panneau de configuration Lync Server.
