...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398074(v=OCS.15)
ms:contentKeyID: 49296066
ms.date: 05/20/2016
...
Assigns a Kerberos account, which is used for Internet Information Services (IIS) authentication, to a site. Cette applet de commande est une nouveauté de Lync Server 2010.
