...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205219(v=OCS.15)
ms:contentKeyID: 49298677
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** The functions carried out by the **Test-CsDataConference** cmdlet are not available in the Panneau de configuration Lync Server.
