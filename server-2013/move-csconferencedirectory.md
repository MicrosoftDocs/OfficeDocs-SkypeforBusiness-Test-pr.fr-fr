...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412968(v=OCS.15)
ms:contentKeyID: 49298754
ms.date: 05/20/2016
...
Moves an existing conference directory from one pool to another. Conference directories are used to help dial-in conferencing users locate conference information. Cette applet de commande est une nouveauté de Lync Server 2010.
