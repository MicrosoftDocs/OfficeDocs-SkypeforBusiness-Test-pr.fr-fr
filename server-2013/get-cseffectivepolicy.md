...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204636(v=OCS.15)
ms:contentKeyID: 49296095
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** The functions carried out by the **Get-CsEffectivePolicy** cmdlet are not directly available in the Panneau de configuration Lync Server.
