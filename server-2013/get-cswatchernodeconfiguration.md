...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204739(v=OCS.15)
ms:contentKeyID: 49296470
ms.date: 04/07/2017
...
**Panneau de configuration Lync Server:** The functions carried out by the **Get-CsWatcherNodeConfiguration** cmdlet are not available in the Panneau de configuration Lync Server.
