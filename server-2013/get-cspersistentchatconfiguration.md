...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205140(v=OCS.15)
ms:contentKeyID: 49298364
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** To view Persistent Chat configuration information in the Panneau de configuration Lync Server, click **Persistent Chat** and then click **Persistent Chat Configuration**.
