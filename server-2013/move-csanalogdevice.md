...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398816(v=OCS.15)
ms:contentKeyID: 49298784
ms.date: 05/20/2016
...
Moves one or more analog devices to a new Registrar pool. An analog device is a telephone or other device that is connected to the public switched telephone network (PSTN). Cette applet de commande est une nouveauté de Lync Server 2010.
