...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ619185(v=OCS.15)
ms:contentKeyID: 49298105
ms.date: 05/20/2016
...
Verifies that replication is working between a Registrar pool and its assigned backup pool. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the Debug-CsInterPoolReplication cmdlet are not available in the Panneau de configuration Lync Server.
