...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204656(v=OCS.15)
ms:contentKeyID: 49296178
ms.date: 05/20/2016
...
Verifies whether or not a pair of users can exchange messages using the Persistent Chat service (formerly known as the Group Chat service). Cette applet de commande est une nouveauté de Lync Server 2013.
...
Panneau de configuration Lync Server: The functions carried out by the **Test-CsPersistentChatMessage** cmdlet are not available in the Panneau de configuration Lync Server.
