...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425869(v=OCS.15)
ms:contentKeyID: 49296917
ms.date: 05/20/2016
...
Returns a list of languages, including regional/minority languages, supported for use with Lync Server dial-in conferences. These languages are used to relay audio messages and instructions to users participating in a conference by using a telephone. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Retrieves the languages list from the local replica of the magasin central de gestion rather than from the magasin central de gestion itself.</p></td>
</tr>
</tbody>
</table>
