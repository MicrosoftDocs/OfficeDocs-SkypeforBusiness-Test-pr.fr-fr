...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204744(v=OCS.15)
ms:contentKeyID: 49296578
ms.date: 05/20/2016
...
Invokes the process in which a Lync Server 2013 database fails over to its mirror database. After failover has been completed, the mirror database will become the principal database and will handle all new database requests. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Invoke-CsDatabaseFailover** cmdlet are not available in the Panneau de configuration Lync Server.
