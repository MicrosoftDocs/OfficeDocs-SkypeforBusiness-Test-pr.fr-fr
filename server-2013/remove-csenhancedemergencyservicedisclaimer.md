...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425810(v=OCS.15)
ms:contentKeyID: 49296775
ms.date: 05/20/2016
...
Removes the disclaimer text that is used globally to prompt for location information for an Enhanced 9-1-1 (E9-1-1) implementation. Cette applet de commande est une nouveauté de Lync Server 2010.
