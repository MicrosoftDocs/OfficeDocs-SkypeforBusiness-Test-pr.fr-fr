...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205036(v=OCS.15)
ms:contentKeyID: 49297857
ms.date: 05/20/2016
...
Removes a presence provider previously configured for use in the organization. Presence providers represent the PresenceProviders property of a collection of user services configuration settings. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Remove-CsPresenceProvider** cmdlet are not available in the Panneau de configuration Lync Server.
