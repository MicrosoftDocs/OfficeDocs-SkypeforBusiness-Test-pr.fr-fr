...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398528(v=OCS.15)
ms:contentKeyID: 49297596
ms.date: 05/20/2016
...
Moves one or more user accounts enabled for Lync Server to a new Registrar pool. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>URL for the hosted migration service used when moving a user to Skype Entreprise Online.</p></td>
</tr>
<tr class="even">
