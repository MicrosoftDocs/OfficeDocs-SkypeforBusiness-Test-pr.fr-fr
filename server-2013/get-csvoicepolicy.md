...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398101(v=OCS.15)
ms:contentKeyID: 49296111
ms.date: 05/20/2016
...
Returns information about one or more voice policies configured for your organization. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Retrieves the voice policy from the local replica of the magasin central de gestion, rather than the magasin central de gestion itself.</p></td>
</tr>
<tr class="even">
<td><p><em>Tenant</em></p></td>
<td><p>Optional</p></td>
<td><p>System.Guid</p></td>
<td><p>Globally unique identifier (GUID) of the Skype Entreprise Online tenant account whose voice policy is to be retrieved. For example:</p>
