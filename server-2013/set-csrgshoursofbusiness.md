...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412929(v=OCS.15)
ms:contentKeyID: 49298715
ms.date: 05/20/2016
...
Configures an existing set of Response Group business hours. Business hour sets are used to indicate the days of the week and the times of day when Response Group agents are typically available to answer phone calls. Cette applet de commande est une nouveauté de Lync Server 2010.
