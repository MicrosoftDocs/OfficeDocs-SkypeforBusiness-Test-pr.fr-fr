...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412937(v=OCS.15)
ms:contentKeyID: 49298713
ms.date: 05/20/2016
...
Creates a new analog device that can be managed by using Lync Server. An analog device is a telephone or other device that is connected to the public switched telephone network (PSTN). Cette applet de commande est une nouveauté de Lync Server 2010.
