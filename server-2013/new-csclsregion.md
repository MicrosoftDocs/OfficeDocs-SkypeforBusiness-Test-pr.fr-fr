...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204658(v=OCS.15)
ms:contentKeyID: 49296185
ms.date: 05/20/2016
...
Creates a new centralized logging configuration region. Centralized logging provides a way for administrators to simultaneously enable or disable event tracing on multiple computers. Centralized logging regions are intended for use with Skype Entreprise Online.
...
**Panneau de configuration Lync Server:** The functions carried out by the **New-CsClsRegion** cmdlet are not available in the Panneau de configuration Lync Server.
