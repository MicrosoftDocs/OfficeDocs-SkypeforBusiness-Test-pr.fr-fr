...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398293(v=OCS.15)
ms:contentKeyID: 49296478
ms.date: 05/20/2016
...
Returns information about the conferencing policies that have been configured for use in your organization. Conferencing policies determine the features and capabilities that can be used in a conference; this includes everything from whether or not the conference can include IP audio and video to the maximum number of people who can attend a meeting. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Retrieves the conferencing policy data from the local replica of the magasin central de gestion rather than from the magasin central de gestion itself.</p></td>
</tr>
</tbody>
</table>
