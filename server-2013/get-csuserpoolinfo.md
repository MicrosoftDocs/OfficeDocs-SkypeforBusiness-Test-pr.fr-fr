...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398615(v=OCS.15)
ms:contentKeyID: 49297839
ms.date: 05/20/2016
...
Returns information about the Registrar pool, backup Registrar pool, and User Services pool that a user has been assigned to. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Retrieves the user pool information from the local replica of the magasin central de gestion rather than from the magasin central de gestion itself.</p></td>
</tr>
</tbody>
</table>
