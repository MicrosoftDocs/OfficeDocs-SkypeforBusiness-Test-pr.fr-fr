...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204986(v=OCS.15)
ms:contentKeyID: 49297571
ms.date: 05/20/2016
...
Associates a mirror database with a Lync Server 2013 database. A database mirror enables you to simultaneously maintain two copies of a database, each copy residing on a different server. Cette applet de commande est une nouveauté de Lync Server 2013.
...
Panneau de configuration Lync Server: The functions carried out by the **Install-CsMirrorDatabase** cmdlet are not available in the Panneau de configuration Lync Server.
