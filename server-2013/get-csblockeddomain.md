...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398424(v=OCS.15)
ms:contentKeyID: 49297359
ms.date: 05/20/2016
...
<td><p>Retrieves the blocked domain data from the local replica of the magasin central de gestion rather than from the magasin central de gestion itself.</p></td>
</tr>
</tbody>
</table>
