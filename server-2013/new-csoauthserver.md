...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205206(v=OCS.15)
ms:contentKeyID: 49298659
ms.date: 05/20/2016
...
Creates a new Open Authorization (OAuth) server for use by the organization. OAuth servers, also known as security token servers, issue security tokens used in server-to-server authentication and authorization. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the New-CsOAuthServer cmdlet are not available in the Panneau de configuration Lync Server.
...
<td><p>Globally unique identifier (GUID) of the Skype Entreprise Online tenant account for which the new OAuth server is being created. For example:</p>
