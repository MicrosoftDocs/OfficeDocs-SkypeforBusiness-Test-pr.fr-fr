...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204971(v=OCS.15)
ms:contentKeyID: 49297514
ms.date: 05/20/2016
...
Removes one or more centralized logging configuration regions. Centralized logging provides a way for administrators to simultaneously enable or disable event tracing on multiple computers. Centralized logging regions are intended for use with Skype Entreprise Online.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Remove-CsClsRegion** cmdlet are not available in the Panneau de configuration Lync Server.
