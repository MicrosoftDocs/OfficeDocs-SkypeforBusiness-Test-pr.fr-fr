...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398994(v=OCS.15)
ms:contentKeyID: 49299100
ms.date: 05/20/2016
...
Creates a new network inter-site policy that defines bandwidth limitations between sites that are directly linked within a call admission control (CAC) configuration. Cette applet de commande est une nouveauté de Lync Server 2010.
