---
title: Index des applets de commande Lync Server 2013
TOCTitle: Index des applets de commande Lync Server 2013
ms:assetid: cd37aba7-3d27-4db9-b69f-3a6da1fb4b4a
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398867(v=OCS.15)
ms:contentKeyID: 49298888
ms.date: 12/10/2016
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Index des applets de commande Lync Server 2013

 

_**Dernière rubrique modifiée :** 2016-12-08_

Microsoft Lync Server 2013 inclut plus de 700 applets de commande que les administrateurs peuvent utiliser pour gérer Lync Server 2013 à partir d’une ligne de commande. Les applets de commande Lync Server sont généralement utilisées avec Lync Server Management Shell. Pour utiliser Lync Server Management Shell, ouvrez une session sur un ordinateur exécutant un service ou un rôle serveur Lync Server, puis cliquez sur **Démarrer**, **Tous les programmes**, **Microsoft Lync Server 2013** et **Lync Server Management Shell**. Une fois Management Shell ouvert, vous pouvez obtenir de l’aide sur une applet de commande directement à partir de la ligne de commande en tapant une commande similaire à la suivante :

    Get-Help New-CsVoicePolicy -Full

La commande précédente permet d’obtenir de l’aide concernant la cmdlet **New-CsVoicePolicy**. Pour afficher l’aide d’une cmdlet différente, remplacez **New-CsVoicePolicy** par le nom de la cmdlet pour laquelle vous souhaitez obtenir de l’aide.

Pour récupérer la liste complète des applets de commande disponibles pour la gestion de Lync Server, tapez les éléments suivants à l’invite de commandes Lync Server Management Shell :

    Get-Command * -Module Lync -CommandType cmdlet

Pour plus d’informations sur l’utilisation de Lync Server Management Shell, voir le blog Lync Server Windows PowerShell à la page [http://go.microsoft.com/fwlink/?linkid=203150\&clcid=0x40C](http://go.microsoft.com/fwlink/?linkid=203150%26clcid=0x40c).

## Applets de commande Lync Server 2013

Les applets de commandes suivantes sont incluses dans Lync Server 2013 :
