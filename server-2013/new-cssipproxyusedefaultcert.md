...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425858(v=OCS.15)
ms:contentKeyID: 49296881
ms.date: 05/20/2016
...
Creates an object reference to the default certificate used by Lync Server. This object reference can then be used to configure a static route to use Transport Layer Security (TLS) as its transport protocol. Cette applet de commande est une nouveauté de Lync Server 2010.
