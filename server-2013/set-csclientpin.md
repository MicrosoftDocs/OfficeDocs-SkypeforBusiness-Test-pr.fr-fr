...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398929(v=OCS.15)
ms:contentKeyID: 49298963
ms.date: 05/20/2016
...
Assigns a new personal identification number (PIN) to the specified user. Cette applet de commande est une nouveauté de Lync Server 2010. Note that the Lync Server 2013 version of this cmdlet can only assign PIN numbers to users homed on Lync Server 2013. You should use the Lync Server 2010 version of Set-CsClientPin to assign PIN numbers to users homed on Lync Server 2010.
