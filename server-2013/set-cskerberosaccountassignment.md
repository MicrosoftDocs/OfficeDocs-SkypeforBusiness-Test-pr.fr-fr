...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398232(v=OCS.15)
ms:contentKeyID: 49296370
ms.date: 05/20/2016
...
Associates a Kerberos account, which is used for IIS Internet Information Services (IIS) authentication, with a site. Cette applet de commande est une nouveauté de Lync Server 2010.
