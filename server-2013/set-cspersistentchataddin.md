...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204721(v=OCS.15)
ms:contentKeyID: 49296430
ms.date: 05/20/2016
...
Modifies an existing Persistent Chat add-in. A Persistent Chat add-in is a customized web page that can be embedded within a Persistent Chat client. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** To modify an existing Persistent Chat add-in using the Panneau de configuration Lync Server, click **Persistent Chat**, click **Add-in**, then double-click the add-in to be modified.
