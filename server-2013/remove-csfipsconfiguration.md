...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205201(v=OCS.15)
ms:contentKeyID: 49298625
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** The functions carried out by the Remove-CsFIPSConfiguration cmdlet are not available in the Panneau de configuration Lync Server.
...
<td><p>Globally unique identifier (GUID) of the Skype Entreprise Online tenant account for the FIPS configuration settings being deleted. For example:</p>
