...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ619178(v=OCS.15)
ms:contentKeyID: 49297164
ms.date: 05/20/2016
...
Tests the ability of a pair of users to schedule, join, and then conduct an online conference using the Unified Communications Web API (UCWA). Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Test-CsUcwaConference** cmdlet are not available in the Panneau de configuration Lync Server.
