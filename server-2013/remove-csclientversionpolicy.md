...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425801(v=OCS.15)
ms:contentKeyID: 49296760
ms.date: 05/20/2016
...
Removes the specified client version policy. Client version policies enable you to specify which clients (such as Microsoft Office Communicator 2007 R2) will be able to log on to your Lync Server system. Cette applet de commande est une nouveauté de Lync Server 2010.
