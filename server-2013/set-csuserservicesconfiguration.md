...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398340(v=OCS.15)
ms:contentKeyID: 49297211
ms.date: 05/20/2016
...
Modifies an existing collection of User Services configuration settings. The User Services service is used to help maintain presence information and manage conferencing. Cette applet de commande est une nouveauté de Lync Server 2010.
