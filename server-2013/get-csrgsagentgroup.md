...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425793(v=OCS.15)
ms:contentKeyID: 49296743
ms.date: 05/20/2016
...
Returns information about the Response Group agent groups configured for use in your organization. An agent group is a collection of agents assigned to a Response Group queue. Agents are the users assigned to answer calls directed to a queue. Cette applet de commande est une nouveauté de Lync Server 2010.
