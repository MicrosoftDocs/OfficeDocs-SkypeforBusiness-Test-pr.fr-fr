...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398484(v=OCS.15)
ms:contentKeyID: 49297476
ms.date: 05/20/2016
...
Modifies an existing set of privacy configuration settings. Privacy configuration settings help determine how much information users make available to other users. Cette applet de commande est une nouveauté de Lync Server 2010.
...
<td><p>Globally unique identifier (GUID) of the Skype Entreprise Online tenant account for the privacy configuration settings being modified. For example:</p>
