...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg425788(v=OCS.15)
ms:contentKeyID: 49296734
ms.date: 12/10/2016
...
Modifies an existing conferencing policy. Conferencing policies determine the features and capabilities that can be used in a conference; this includes everything from whether or not the conference can include IP audio and video to the maximum number of people who can attend a meeting. Cette applet de commande est une nouveauté de Lync Server 2010.
