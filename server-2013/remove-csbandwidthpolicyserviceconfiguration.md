...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398877(v=OCS.15)
ms:contentKeyID: 49298911
ms.date: 05/20/2016
...
Removes an existing bandwidth policy service configuration. Cette applet de commande est une nouveauté de Lync Server 2010.
