...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398859(v=OCS.15)
ms:contentKeyID: 49298844
ms.date: 05/20/2016
...
Modifies the property values for one or more Edge Servers. Edge Servers are used to provide connectivity between your internal network and the Internet. Cette applet de commande est une nouveauté de Lync Server 2010.
...
The command shown in Example 1 modifies the internal and external SIP ports for the serveur Edge "EdgeServer:atl-edge-001.litwareinc.com".
...
<td><p>Port used for SIP communications between the serveur Edge and client devices. The initial value is set in Générateur de topologie but can be changed by specifying a new value for this parameter.</p></td>
</tr>
<tr class="even">
...
<td><p>Optional</p></td>
<td><p>System.UInt16</p></td>
<td><p>Port used for Persistent Shared Object Model (PSOM) communications between the serveur Edge and client devices. The initial value is set in Générateur de topologie but can be changed by specifying a new value for this parameter.</p></td>
</tr>
<tr class="even">
<td><p><em>DataPsomServerPort</em></p></td>
<td><p>Optional</p></td>
<td><p>System.UInt16</p></td>
<td><p>Port used for PSOM communications between the serveur Edge and other servers.</p></td>
</tr>
<tr class="odd">
...
<td><p>Service location of the serveur Edge to be modified. For example: -Identity &quot;EdgeServer:atl-edge-001.litwareinc.com&quot;.</p>
...
<td><p>Optional</p></td>
<td><p>System.UInt16</p></td>
<td><p>Port used for external media relay traffic using the Transmission Control Protocol (TCP). The default value is 444 if your Edge server has a single IP address. If your Edge server has multiple IP addresses then the default value is 443. These values are initially set in Générateur de topologie but can be changed by specifying a new value for this parameter.</p></td>
</tr>
<tr class="odd">
...
<td><p>Service location of the Registrar to be associated with the serveur Edge. For example: -Registrar &quot;Registrar:atl-cs-001.litwareinc.com&quot;.</p></td>
</tr>
<tr class="odd">
