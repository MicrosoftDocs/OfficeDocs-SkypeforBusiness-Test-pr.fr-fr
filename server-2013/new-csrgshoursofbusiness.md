...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398291(v=OCS.15)
ms:contentKeyID: 49296477
ms.date: 05/20/2016
...
Creates a new set of application Response Group business hours. Business hour sets are used to indicate the days of the week and the times of day when Response Group agents are typically available to answer phone calls. Cette applet de commande est une nouveauté de Lync Server 2010.
