...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204952(v=OCS.15)
ms:contentKeyID: 49297385
ms.date: 05/20/2016
...
Modifies an existing Persistent Chat category. A Persistent Chat category represents a collection of Persistent Chat chat rooms. Each chat room must be associated with a category. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** To modify an existing Persistent Chat category using the Panneau de configuration Lync Server, click **Persistent Chat**, click **Category**, then double-click the category to be modified.
