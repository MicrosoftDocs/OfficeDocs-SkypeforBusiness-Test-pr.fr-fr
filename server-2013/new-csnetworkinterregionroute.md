...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398779(v=OCS.15)
ms:contentKeyID: 49298214
ms.date: 05/20/2016
...
Creates a new route that connects network regions within a call admission control (CAC) configuration. Cette applet de commande est une nouveauté de Lync Server 2010.
