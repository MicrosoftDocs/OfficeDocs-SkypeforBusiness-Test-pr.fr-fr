...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204631(v=OCS.15)
ms:contentKeyID: 49296080
ms.date: 05/20/2016
...
**Panneau de configuration Lync Server:** To create a new XMPP allowed partner using Panneau de configuration Lync Server, click External User Access, click XMPP Federated Partners, and then click New.
