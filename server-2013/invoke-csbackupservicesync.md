...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205374(v=OCS.15)
ms:contentKeyID: 49299350
ms.date: 05/20/2016
...
Manually invokes backup synchronization between a Lync Server 2013 pool and its designated backup pool. This allows administrators to synchronize data without waiting for Lync Server replication. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Invoke-CsBackupServiceSync** cmdlet are not available in the Panneau de configuration Lync Server.
