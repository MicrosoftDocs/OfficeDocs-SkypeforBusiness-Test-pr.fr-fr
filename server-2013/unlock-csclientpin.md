...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg412982(v=OCS.15)
ms:contentKeyID: 49299254
ms.date: 05/20/2016
...
Enables an administrator to unlock the personal identification number (PIN) for a specified user. Cette applet de commande est une nouveauté de Lync Server 2010.
