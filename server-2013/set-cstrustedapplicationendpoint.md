...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398509(v=OCS.15)
ms:contentKeyID: 49297530
ms.date: 05/20/2016
...
Modifies an existing endpoint contact for a trusted application. Cette applet de commande est une nouveauté de Lync Server 2010.
...
A trusted application endpoint is an Active Directory contact object that enables routing of calls to a trusted application. This cmdlet modifies an existing endpoint contact object in services de domaine Active Directory.
