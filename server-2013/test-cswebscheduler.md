...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ204829(v=OCS.15)
ms:contentKeyID: 49296974
ms.date: 05/20/2016
...
Verifies whether or not a user can employ the Lync Server 2013 Web scheduler to schedule an online meeting. Cette applet de commande est une nouveauté de Lync Server 2013.
...
**Panneau de configuration Lync Server:** The functions carried out by the **Test-CsWebScheduler** cmdlet are not available in the Panneau de configuration Lync Server.
